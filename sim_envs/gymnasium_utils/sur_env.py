...
class SurEnv(gym.Env):
    """
    A gym Env wrapper for SurEnv to enable surgical simulation.
    ...
    def step(self, action):
        raise NotImplementedError("Step logic must be implemented in the task-specific environment.")
    ...
    def _env_setup(self):
        """ Sets up the simulation environment. Override in subclasses.
        """
